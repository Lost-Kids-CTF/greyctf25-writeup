...
bool checkgameended()
{
    ...
    for (int i = 0; i < 8; i++)
    {
        for (int j = 0; j <= 4; j++)
        {
            if ((board[i][j] == board[i][j + 1] && board[i][j + 1] == board[i][j + 2] && board[i][j + 2] == board[i][j + 3]) && (board[i][j] == player1symbol || board[i][j] == player2symbol))
            {
                return true;
            }
        }
    ...
    for (int j = 0; j < 8; j++)
    {
        for (int i = 0; i <= 4; i++)
        {
            if ((board[i][j] == board[i + 1][j] && board[i + 1][j] == board[i + 2][j] && board[i + 2][j] == board[i + 3][j]) && (board[i][j] == player1symbol || board[i][j] == player2symbol))
            {
                return true;
            }
        }
    ...
    for (int i = 0; i <= 4; i++)
    {
        for (int j = 0; j <= 4; j++)
        {
            if ((board[i][j] == board[i + 1][j + 1] && board[i + 1][j + 1] == board[i + 2][j + 2] && board[i + 2][j + 2] == board[i + 3][j + 3]) && (board[i][j] == player1symbol || board[i][j] == player2symbol))
            {
                return true;
            }
        }
